...
The evil-emacs-cursor-model-mode unify these to a cursor between model in both states.
...
Binding (evil-append-line) makes sense in a cursor between model, whereas (evil-append) does not.
