...
When the commands change as described above, you might start to adopt a new philosophy.
The idea is to work with motions among line nuggets.

With this mode the /commands/ focus on the current line and you can replace all layers with motions.
...
The /line nugget/ mindset will use less commands and the logic is easier to learn and internalize.
